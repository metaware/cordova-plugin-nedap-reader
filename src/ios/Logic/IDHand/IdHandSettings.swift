...
//      return appDelegate.idHandConnector.selectedIdHand?.outputPowerBoundaries?.max ??
  ...
  var minimumOutputPower : Int {
    get {
      // Get reference to the App Delegate
//      let appDelegate = UIApplication.sharedApplication().delegate as! AppDelegate
//      return appDelegate.idHandConnector.selectedIdHand?.outputPowerBoundaries?.min ??
